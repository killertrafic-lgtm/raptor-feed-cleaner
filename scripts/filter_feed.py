...
GOOGLE_CATEGORY_MAP = [
    # Оптика — более точные категории Google
    ("Тепловіз",        "Cameras & Optics > Optics > Monoculars"),
    ("Нічн",            "Cameras & Optics > Optics > Monoculars"),
    ("ПНБ",             "Cameras & Optics > Optics > Monoculars"),
    ("Монокуляр",       "Cameras & Optics > Optics > Monoculars"),
    ("Бінокл",          "Cameras & Optics > Optics > Binoculars"),
    ("Оптика",          "Cameras & Optics > Optics"),
    # ВАЖНО: "Аксесуари до Шолому" ПЕРЕД "Шолом", иначе словит общую категорию шлемов
    ("Аксесуари",       "Apparel & Accessories > Costumes & Accessories > Costume Accessories"),
    # Защита и снаряжение — Costumes & Accessories (ближайшее в Google taxonomy)
    ("Бронеплит",       "Apparel & Accessories > Costumes & Accessories"),
    ("Шолом",           "Apparel & Accessories > Costumes & Accessories"),
    ("Бронежилет",      "Apparel & Accessories > Costumes & Accessories"),
    # Плитоноски и підсумки — Backpacks (это сумки/рюкзаки для несения снаряжения)
    ("Плитонос",        "Luggage & Bags > Backpacks"),
    ("Підсум",          "Luggage & Bags > Backpacks"),
    # Взуття
    ("Черевик",         "Apparel & Accessories > Shoes"),
    ("Взуття",          "Apparel & Accessories > Shoes"),
    # Одяг — точные подкатегории
